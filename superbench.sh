...
about() {
	...
	echo " Copyright (C) 2019 Oldking And wn789.com"
	echo -e " ${RED}Welcome to use!${PLAIN}"
	echo ""
}
...
print_speedtest() {
    ...
    speed_test '5317' 'Lianyungang5G CT'
    ...
    speed_test '16375' 'Shenyang      CM'
    speed_test '25728' 'Dalian        CM'
