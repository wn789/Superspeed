...
SystemInfo_GetNetworkInfo() {
    local LBench_TempResult_LocalIP_IPV4="$(curl --connect-timeout 10 -fsL4 "https://api.saltyfish.eu/ipdb.php?appkey=jmn8dvncsb2batcyhs7pgiut&ip=")"
    LBench_Result_LocalIP_IPV4="$(PharseJSON "${LBench_TempResult_LocalIP_IPV4}" "IP")"
    LBench_Result_LocalIP_IPV6="$(curl --connect-timeout 10 -fsL6 http://api-ipv6.ip.sb)"
    # 判断三种网络情况：
    # - IPV4 Only：只有IPV4
    # - IPV6 Only：只有IPV6
    ...
    if [ "${LBench_Result_LocalIP_IPV4}" != "" ] && [ "${LBench_Result_LocalIP_IPV6}" = "" ]; then
        ...
        local IPAPI_Result_IPV4="$(curl -fsL4 --connect-timeout 10 "https://api.saltyfish.eu/ipdb.php?appkey=jmn8dvncsb2batcyhs7pgiut&ip=${LBench_Result_LocalIP_IPV4}")"
    # 判断IPV6 Only
    elif [ "${LBench_Result_LocalIP_IPV4}" = "" ] && [ "${LBench_Result_LocalIP_IPV6}" != "" ]; then
        LBench_Result_NetworkStat="ipv6only"
        local IPAPI_Result_IPV6="$(curl -fsL6 --connect-timeout 10 https://api-ipv6.ip.sb/geoip)"
    # 判断双栈
    elif [ "${LBench_Result_LocalIP_IPV4}" != "" ] && [ "${LBench_Result_LocalIP_IPV6}" != "" ]; then
...
Function_Speedtest_Fast() {
	...
	Run_Speedtest "17251" "广州电信"
	Run_Speedtest "27594" "广州电信5G"
	Run_Speedtest "27377" "北京电信5G"
	Run_Speedtest "17145" "合肥电信5G"
	Run_Speedtest "26352" "南宁电信5G"
	Run_Speedtest "5396" "苏州电信5G"
	Run_Speedtest "5317" "连云港电信5G"
	Run_Speedtest "28225" "长沙电信"
	Run_Speedtest "29026" "成都电信"
	Run_Speedtest "19076" "重庆电信"
	Run_Speedtest "7509" "杭州电信"
	Run_Speedtest "23844" "武汉电信"
	Run_Speedtest "27154" "天津联通5G"
	Run_Speedtest "26180" "济南联通5G"
	Run_Speedtest "24447" "上海联通5G"
	Run_Speedtest "26678" "广州联通5G"
	Run_Speedtest "5145" "北京联通"
	Run_Speedtest "9484" "吉林联通"
	Run_Speedtest "13704" "南宁联通"
	Run_Speedtest "4870" "长沙联通"
	Run_Speedtest "2461" "成都联通"
	Run_Speedtest "4884" "福州联通"
	Run_Speedtest "5485" "武汉联通"
	Run_Speedtest "4863" "西安联通"
    Run_Speedtest "25637" "上海移动"
	Run_Speedtest "6611" "广州移动"
	Run_Speedtest "4515" "深圳移动"
	Run_Speedtest "27100" "青岛移动5G"
	Run_Speedtest "25881" "济南移动5G"
	Run_Speedtest "26331" "郑州移动5G"
	Run_Speedtest "17184" "天津移动5G"
	Run_Speedtest "26850" "无锡移动5G"
	Run_Speedtest "25637" "上海移动5G"
	Run_Speedtest "27249" "南宁移动5G"
	Run_Speedtest "6715" "宁波移动5G"
	Run_Speedtest "26404" "合肥移动5G"
	Run_Speedtest "28491" "长沙移动5G"
    # 执行完成, 标记FLAG
...
Function_BestTrace_Full() {
    ...
    if [ "${LBench_Result_NetworkStat}" = "ipv4only" ] || [ "${LBench_Result_NetworkStat}" = "dualstack" ]; then
        ...
        Run_BestTrace "203.116.46.162" "TCP" "30" "新加坡StarHub"
        ...
        Run_BestTrace "175.122.253.62" "TCP" "30" "韩国SK"
        ...
        Run_BestTrace "118.85.205.180" "TCP" "30" "俄罗斯电信163"
